...
$name = $_POST['modal-form__name'];
$phone = $_POST['modal-form__phone'];
$email = $_POST['modal-form__email'];
...
$mail->Body    = ' Оставил заявку: ' .$name .'<br> Его телефон: ' .$phone. '<br>Почта этого пользователя: ' .$email;
$mail->AltBody = '';
